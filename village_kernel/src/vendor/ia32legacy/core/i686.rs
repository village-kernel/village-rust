...
// PS2 controller register bits
pub const PS2_CTL_FIRST_PORT_INT_POS: u8 = 0;
pub const PS2_CTL_FIRST_PORT_INT_MSK: u8 = 0x1 << PS2_CTL_FIRST_PORT_INT_POS;
pub const PS2_CTL_SECOND_PORT_INT_POS: u8 = 1;
pub const PS2_CTL_SECOND_PORT_INT_MSK: u8 = 0x1 << PS2_CTL_SECOND_PORT_INT_POS;
pub const PS2_CTL_SYSTEM_FLAG_POS: u8 = 2;
pub const PS2_CTL_SYSTEM_FLAG_MSK: u8 = 0x1 << PS2_CTL_SYSTEM_FLAG_POS;
pub const PS2_CTL_FRIST_PORT_CLK_POS: u8 = 4;
pub const PS2_CTL_FRIST_PORT_CLK_MSK: u8 = 0x1 << PS2_CTL_FRIST_PORT_CLK_POS;
pub const PS2_CTL_SECOND_PORT_CLK_POS: u8 = 5;
pub const PS2_CTL_SECOND_PORT_CLK_MSK: u8 = 0x1 << PS2_CTL_SECOND_PORT_CLK_POS;
pub const PS2_CTL_FRIST_PORT_TRANS_POS: u8 = 6;
pub const PS2_CTL_FRIST_PORT_TRANS_MSK: u8 = 0x1 << PS2_CTL_FRIST_PORT_TRANS_POS;
